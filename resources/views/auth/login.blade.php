...
<div class="max-w-md mx-auto mt-10 bg-white p-6 rounded-md shadow">
    ...
    <form action="{{ route('login') }}" method="POST" class="space-y-4">
        ...
        <div >
            <button type="submit" class="bg-blue-500 w-full font-semibold text-center flex items-center justify-center button hover:shadow">دخول</button>
        </div>
    </form>
</div>
<div class="text-center py-3">
<p>ليس لديك حساب؟ <a href="{{ route('register') }}"><span class="hover:text-red-500 ">انشئ</span></a></p>
</div>
@endsection
